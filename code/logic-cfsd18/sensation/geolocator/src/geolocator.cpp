...
void Geolocator::setUp()
{
    //%%%%%%%%%%%%%%%%%%%%%%%CONFIG STUFF%%%%%%%%%%%%%%%%%%%%%%
      ...
      double const qX = kv.getValue<double>("logic-cfsd18-sensation-geolocator.Q.X");
      double const qY = kv.getValue<double>("logic-cfsd18-sensation-geolocator.Q.Y");
      double const qVelX = kv.getValue<double>("logic-cfsd18-sensation-geolocator.Q.VelX");
      double const qVelY = kv.getValue<double>("logic-cfsd18-sensation-geolocator.Q.VelY");
      double const qYaw = kv.getValue<double>("logic-cfsd18-sensation-geolocator.Q.Yaw");
      double const qHeading= kv.getValue<double>("logic-cfsd18-sensation-geolocator.Q.Heading");
      ...
      double const rX = kv.getValue<double>("logic-cfsd18-sensation-geolocator.R.X");
      double const rY = kv.getValue<double>("logic-cfsd18-sensation-geolocator.R.Y");
      double const rVelX = kv.getValue<double>("logic-cfsd18-sensation-geolocator.R.VelX");
      double const rAccX = kv.getValue<double>("logic-cfsd18-sensation-geolocator.R.AccX");
      double const rAccY = kv.getValue<double>("logic-cfsd18-sensation-geolocator.R.AccY");
      double const rYaw = kv.getValue<double>("logic-cfsd18-sensation-geolocator.R.Yaw");
      double const rHeading = kv.getValue<double>("logic-cfsd18-sensation-geolocator.R.Heading");
    ...
    double const vM = kv.getValue<double>("logic-cfsd18-sensation-geolocator.vehicle-parameter.m");
    double const vIz = kv.getValue<double>("logic-cfsd18-sensation-geolocator.vehicle-parameter.Iz");
    double const vG = kv.getValue<double>("logic-cfsd18-sensation-geolocator.vehicle-parameter.g");
    double const vL = kv.getValue<double>("logic-cfsd18-sensation-geolocator.vehicle-parameter.l");
    double const vLf = kv.getValue<double>("logic-cfsd18-sensation-geolocator.vehicle-parameter.lf");
    double const vLr = kv.getValue<double>("logic-cfsd18-sensation-geolocator.vehicle-parameter.lr");
    double const vMu = kv.getValue<double>("logic-cfsd18-sensation-geolocator.vehicle-parameter.mu");

    m_vehicleModelParameters << vM,vIz,vG,vL,vLf,vLr,vMu;

    //%%%%%%%%%%%%System Params%%%%%%%%%%%%%%%%%%%%%%

    double const latitude = getKeyValueConfiguration().getValue<double>("logic-cfsd18-sensation-geolocator.GPSreference.latitude");
    double const longitude = getKeyValueConfiguration().getValue<double>("logic-cfsd18-sensation-geolocator.GPSreference.longitude");
    m_gpsReference[0] = latitude;
    m_gpsReference[1] = longitude;

    m_sampleTime = kv.getValue<double>("logic-cfsd18-sensation-geolocator.T");
    m_senderStamp = kv.getValue<int>("logic-cfsd18-sensation-geolocator.senderStamp");
    m_imuSenderStamp = kv.getValue<int>("logic-cfsd18-sensation-geolocator.imuSenderStamp");
