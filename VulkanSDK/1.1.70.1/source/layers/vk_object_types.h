...
typedef enum VulkanObjectType {
    ...
    kVulkanObjectTypeDescriptorUpdateTemplateKHR = 32,
    kVulkanObjectTypeSamplerYcbcrConversionKHR = 33,
    kVulkanObjectTypeDebugReportCallbackEXT = 34,
    kVulkanObjectTypeObjectTableNVX = 35,
    kVulkanObjectTypeIndirectCommandsLayoutNVX = 36,
    kVulkanObjectTypeDebugUtilsMessengerEXT = 37,
    kVulkanObjectTypeValidationCacheEXT = 38,
...
static VkObjectType convertDebugReportObjectToCoreObject(VkDebugReportObjectTypeEXT debug_report_obj){
...
// Helper function to convert from VkDebugReportObjectTypeEXT to VkObjectType
static VkDebugReportObjectTypeEXT convertCoreObjectToDebugReportObject(VkObjectType core_report_obj){
